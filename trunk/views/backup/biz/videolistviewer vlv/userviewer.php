...
class videolistviewer vlv {
	...
	function __construct($fullname) {
		...
		$_SESSION['osNodes'][$fullname]['biz']='videolistviewer vlv';
	}
	...
	*****************************/
	function onShowAdLinks($info){
		if($this->showAdLinks){
			...
			$this->vlv->bookModeUser("myad",$this->userData['UID']);
	...
	function onShowPubLinks($info){
		if($this->showPubLinks){
			...
			$this->vlv->bookModeUser("mypub",$this->userData['UID']);
