...
<body>
	...
	<input type=hidden name=paymentType value='Sale' old_value='<?php /*echo $paymentType*/?>' >
        ...
        <th>Shopping cart Products:</th>
			 <tr>
					<td class="field">
						Balance:</td>
					<td>
						<input type="text" size="30" maxlength="32" name="L_NAME0" value="RocketViews" disabled /> </td>
				...
				<td>
				   ...
				   <td>  <input type="text" size="3" maxlength="32" name="L_QTY0" value="1" hidden  /> </td>
